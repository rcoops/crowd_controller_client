...
class AddFriendFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        btn_cancel_add_friend.setOnClickListener { activity.onBackPressed() }
        btn_add_friend.setOnClickListener {
            mListener?.onFragmentInteraction(actv_user_detail.text.toString())
        }
        return view
    }
    ...
    interface OnFragmentInteractionListener {
        ...
        fun onFragmentInteraction(userDetail: String)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): AddFriendFragment {
